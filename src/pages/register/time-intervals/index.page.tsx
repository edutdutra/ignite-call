...
import {IntervalBox, IntervalsContainer, IntervalDay, IntervalInputs, IntervalItem, FormError} from "./styles";
...
const timeIntervalsFormSchema = z.object({
    intervals: z.array(
        ...
        }, {message: 'O horário de término deve ser pelo menos 1h distante do inicio'})
})
...
export default function TimeIntervals() {
    const {control, register, handleSubmit, formState: {isSubmitting, errors}, watch} = useForm<TimeIntervalsFormInput>({
